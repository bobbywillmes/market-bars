...
dotenv.config()
import { getAggsPaginated, csvFromIntraday, csvFromDailyish } from "../../utils/massiveClient.js";
import { addATR } from "../../utils/atr.js";
...
/** Customize here */
const TICKERS = ["SPY", "QQQ", "DIA", "IWM", "AAPL", "AMZN", "GOOG", "META", "MSFT"];
const MULTIPLIER = 30;              // 30-minute bars
const TIMESPAN = "minute";            // minute, hour, day, week, month
const ADJUSTED = true;
const SORT = "asc";
